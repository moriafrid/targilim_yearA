...
# run over r experiments to callculate g2
...
#function to callculate the g2 to difrrent mass of sun
...
#function to callculate the g2 with average on the intensity every 10 realization
