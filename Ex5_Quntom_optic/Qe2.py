...
if __name__ == '__main__':
    ...
    sun, E_earth, inty, intense, detector500, momentum2 = run(realization_num, 30, 5, 100)
    ...
    plots(xdata, ydata, 'The momentum2 g2(n) Q2')
    popt2, pcov = curve_fit(sinc, xdata, ydata, bounds=((0.01, 495, 0.5), (0.3, 505, 1.1)))
