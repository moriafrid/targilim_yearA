...
if __name__ == '__main__':
    ...
    plots(xdata, ydata, 'The momentum2 g2(n)')
    #fit g2 to 1+sinc^2
    ...
    plt.hlines(y=properties["width_heights"], xmin=properties["left_ips"], xmax=properties["right_ips"], color="C1",linewidth=3)
    plt.savefig('The momentum with FWHM.png')
    ...
    plt.plot(sun_mass, one_toX(sun_mass, *popt), 'g-', linewidth=3)
    plt.savefig('FWMH for diffrent sun mass.png')

    #5
    print("q5")
    #calculation of g2 with mean on 10 trials- lead to less contrast
    plots(xdata, ydata, 'The g2 with and witoht mean on 10 realization')
